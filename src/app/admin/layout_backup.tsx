...
function AdminLayoutContent({
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-gray-100 text-slate-800 overflow-hidden">
      <Sidebar>
        <SidebarBody>
          <DesktopSidebar>
            {/* Logo */}
            <div className="flex items-center justify-between h-16 px-4 border-b border-slate-200">
              <Link href="/admin/dashboard" className="flex items-center space-x-3 min-w-max">
                ...
                <motion.span 
                  className="text-lg font-semibold whitespace-nowrap text-slate-800"
                  animate={{
                    opacity: open ? 1 : 0,
