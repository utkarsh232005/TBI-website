...
import { FileTextIcon, UserCircle, KeyRound, Mail, CalendarDays, FlaskConical, Building, Landmark, Phone, ExternalLink, GraduationCap, User, Info, CheckCircle, XCircle } from "lucide-react";
    ...
    <div className="submission-card">
      ...
      <div className="submission-card-header">
        <div className="submission-icon-wrapper">
          <User className="submission-icon-large" />
        </div>
      ...
      <div className="submission-card-content">
        <div className="submission-info-grid">
          ...
          {(submission.course || submission.yearOfStudy) && (
            <div className="submission-info-item">
              <GraduationCap className="submission-info-icon" />
              <div className="submission-info-content">
                <div className="submission-info-label">Academic Info</div>
                <div className="submission-info-value">
                  {[submission.course, submission.yearOfStudy].filter(Boolean).join(' - ')}
                </div>
              </div>
            </div>
          )}
        ...
        {(submission.startupIdea || submission.idea) && (
          <div className="submission-info-item" style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
            ...
            <div className="submission-info-content">
              <div className="submission-info-label">Startup Idea</div>
              <div className="submission-info-value">
