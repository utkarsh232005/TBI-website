        ...
        <div className="grid gap-4 py-4 text-sm">
          ...
          {submission.linkedin && (
            <div className="flex items-center gap-2">
              ...
              <strong>LinkedIn:</strong> <a href={submission.linkedin} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">{submission.linkedin}</a>
            </div>
          )}
          {submission.course && (
            <div className="flex items-center gap-2">
          ...
          {submission.startupIdea && (
            <div>
              <strong className="flex items-center gap-2"><Tags className="h-4 w-4 text-gray-500" />Startup Idea:</strong>
              <p className="ml-6 text-gray-700 whitespace-pre-wrap">{submission.startupIdea}</p>
            </div>
          )}
          {submission.message && (
            <div>
              <strong className="flex items-center gap-2"><MessageSquare className="h-4 w-4 text-gray-500" />Message:</strong>
              <p className="ml-6 text-gray-700 whitespace-pre-wrap">{submission.message}</p>
            </div>
          )}
          {submission.status && (
            <div className="flex items-center gap-2">
