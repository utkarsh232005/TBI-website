...
export default function EventCard({ event }: EventCardProps) {
  return (
    <Card className="group flex flex-col overflow-hidden bg-card shadow-lg transition-all duration-300 hover:shadow-primary/20 rounded-2xl border border-border">
